...
public class breakfast2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("recipes/breakfast");
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    bookmarkRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot bookmarkSnapshot) {
                            ...
                            LunchRecipe lunchRecipe = new LunchRecipe(name, preTime, image, cal, isBookmarked,vedio,id,"breakfast");
